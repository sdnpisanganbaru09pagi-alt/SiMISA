...
async function downloadItemQrPngCard(item){
  ...
  downloadBlob(`QR_${fileBase}.png`, blob);
}
  ...
  modal.innerHTML = `
    <div style="background:#fff;border-radius:14px;padding:16px;max-width:420px;width:100%;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;">
        ...
        <button id="printQrBtn" class="btn ghost" type="button">🖨️ Print</button>
      </div>
      <div style="margin-top:10px;font-size:12px;color:#6b7280;">
        File label disarankan lewat PDF atau Print agar format informasi barang konsisten.
      </div>
    </div>
  `;
  document.body.appendChild(modal);
